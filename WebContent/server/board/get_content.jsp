...
<%
	...
	String sql = "select a1.content_idx, a1.content_subject, a1.content_text, a1.content_file, a2.user_name, a1.content_writer_idx, to_char(a1.content_date, 'YYYY-MM-DD') as content_date "
